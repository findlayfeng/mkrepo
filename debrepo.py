...
def split_pkg_path(pkg_path):
    """Get package distribution, component, and architecture information
    from the package location and package name.

    Keyword arguments:
    pkg_path - package path (string).

    Return a tuple containing information about the package's distribution,
